...
<div class="wrap">
    ...
    <h2 class="notice">Displaying Content on Your site</h2>
    ...
    <table class="iconfinder-portfolio-params" id="toc">
        <head>
            <tr>
                <th>Parameter</th>
        ...
        <tbody>
            ...
            <tr>
                <td><a href="#img_size">img_size</a></td>
    ...
    <h3 class="notice"     id="count">count</h3>
    ...
    <h3 class="notice"     id="sort_by">sort_by and sort_order</h3>
    ...
    <h3 class="notice"     id="omit">omit</h3>
    ...
    <h3 class="notice"     id="style">style</h3>
    ...
    <h3 class="notice"     id="type">type</h3>
    ...
    <h3 class="notice"     id="collection">collection</h3>
    ...
    <h3 class="notice"     id="sets">sets</h3>
    ...
    <h3 class="notice"     id="categories">categories</h3>
    ...
    <h3 class="notice"     id="img_size">img_size</h3>
    ...
    <h3 class="notice"     id="mixed">Mixing Filters</h3>
    ...
    <h3 class="notice"     id="shortcode-in-themes">Calling the Shortcode in Theme files</h3>
    ...
    <h3 class="notice"     id="theming">Theming the Iconfinder Portfolio output</h3>
    ...
    <h3 class="notice"     id="img-carousel">Owly image carousel theme</h3>
    ...
    <h3 class="notice"     id="credits">Credits</h3>
