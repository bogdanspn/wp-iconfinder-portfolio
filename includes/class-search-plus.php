...
class Gee_Search_Plus_Engine {
	...
	function __construct() {
        ...
        if (! function_exists('_gee_searchplus_options')) {
            return;
            //TODO: How should this be handled? We can do anything without the options.
        }
        
		$this->options = _gee_searchplus_options();
	...
	function get_stopwords( $wp_stopwords = array() ) {
		...
		// $stopwords is loaded through a language file
